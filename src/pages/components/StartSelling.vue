...
<template>
  <div class="mt-20 w-full flex items-center justify-between rounded-xl bg-[#101010] pa-10 container">
    <div class="max-w-70% flex flex-col items-start">
      ...
      <p mt-5 text-white>
        Nós cuidamos da captação de clientes e de todo o processo burocrático para você. <br>
        O seu papel é criar designs incríveis que superem as expectativas e satisfaçam as necessidades dos clientes.
        <br><br>
...
.container {
    box-shadow: rgba(162, 89, 255, 0.25) 0px 50px 100px -20px, rgba(123, 40, 233, 0.3) 0px 30px 60px -30px, rgba(218, 223, 228, 0.15) 0px -2px 6px 0px inset;
}
...
.card {
  ...
  -webkit-animation: surface 10s linear infinite;
...
.card.rotate {
  -webkit-animation: surface 10s linear infinite, rotate 6s linear infinite;
